...
public class FXMLRealizaVendaController implements Initializable {
    ...
    @FXML
    private TableColumn<VendaItem, Integer> TableValor;
    
    final ObservableList<VendaItem> obsprodutos = FXCollections.observableArrayList(); 
...
//       
//        try {
//            TextFieldNumero.setText(String.valueOf(v.getNumerodao()));
...
public void lancar(){
   ...
   //TextFieldValorTotal.setText(value);
}
